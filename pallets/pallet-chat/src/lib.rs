...
pub mod pallet {
	...
	// type Balance<T> = <<T as Config>::Currency as Currency<<T as
	...
	pub(super) type MsgStorage<T: Config> =
		StorageMap<_, Blake2_128Concat, u128, Message<T::AccountId>, ValueQuery>;
